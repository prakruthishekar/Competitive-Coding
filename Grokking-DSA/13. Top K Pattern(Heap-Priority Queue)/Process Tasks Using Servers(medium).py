...
# n​​​​​​ and m​​​​​​ respectively. servers[i] is the weight of the i​​​​​​th​​​​ server, and tasks[j]
# is the time needed to process the j​​​​​​th​​​​ task in seconds.

# Tasks are assigned to the servers using a task queue. Initially, all 
# servers are free, and the queue is empty.

# At second j, the jth task is inserted into the queue (starting with the
#  0th task being inserted at second 0). As long as there are free servers 
# and the queue is not empty, the task in the front of the queue will be assigned 
# to a free server with the smallest weight, and in case of a tie, it is assigned
